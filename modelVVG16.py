...
emotion_model = Sequential([
    Conv2D(64, kernel_size=(3, 3),padding="same", activation='relu', input_shape=(224, 224, 1)),
...
emotion_model_info = emotion_model.fit(train_generator, epochs=5, validation_data=validation_generator)
